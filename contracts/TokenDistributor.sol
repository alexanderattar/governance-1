...
contract TokenDistributor {
    ...
    uint256 public constant CONTRACT_ACTIVE = 30 days;
    ...
    bytes32 constant GTC_TOKEN_CLAIM_TYPEHASH =
        keccak256(
    ...
    function claimTokens(
        ...
        require(
            IERC20(token).transfer(user_address, user_amount),
    ...
    function transferUnclaimed() public {
        ...
        require(
            IERC20(token).transfer(timeLockContract, remainingBalance),
